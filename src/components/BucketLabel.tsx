...
const BucketLabel = () => {
  return (
   <div>
     <Link
    href={"/"}
    className="flex min-h-20 justify-center items-center px-2 w-full max-sm:gap-8 bg-[#F1F1F1] rounded-lg "
  >
    <Image
    ...
    <p className="text-center flex flex-col leading-none -gap-5  font-medium  outline-none ring-sidebar-ring text-sidebar-foreground/80">
      <span className="font-bucket sm:text-7xl text-2xl leading-none ">BuCkeT</span>
